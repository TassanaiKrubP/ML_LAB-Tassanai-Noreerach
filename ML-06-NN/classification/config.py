...
MAX_PER_CLASS = 582    # จำกัดจำนวนรูปต่อคลาส  ใส่ None ถ้าใช้ทั้งหมด
...
CONFIGURATIONS = [
    {"name": "1-hidden-128",         "hidden": [128],           "dropout": 0.1},
    {"name": "2-hidden-256-128",     "hidden": [256, 128],      "dropout": 0.1},
    {"name": "3-hidden-512-256-128", "hidden": [512, 256, 128], "dropout": 0.1},
]
